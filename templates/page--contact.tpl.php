...
<link rel="stylesheet" href="<?php print $base_url . '/' . drupal_get_path('theme', 'divseekcanada_theme') . '/css/contact.css' ?>">
          ...
          <section id="post-content" role="main">
            ...
            <div id="contact-content">
              <div id="contact-info-container">
                <i class="fas fa-envelope-open-text fa-icon fa-inverse"></i>
                <h2>Contact Us</h2>
                <p>If you have any questions, feedback, data or other inquiries, please do not hesitate to contact us!</p>
                <br />
                <p>We are currently looking for additional data for our flagship crops, as well as, exploring partnerships with Canadian researchers for other crops.</p>
              </div>
